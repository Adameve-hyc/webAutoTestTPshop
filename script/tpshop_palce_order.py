...
from utils import DriverUtil, driver_to_new_handle_func, get_text_element_func
...
class TestTPShopPlaceOrder(unittest.TestCase):
    ...
    def test_01place_order(self):
        ...
        self.cart_paroxy.go_check_order_page()  # 购物车页面点击去结算
        sleep(4)
        self.check_roder_proxy.go_to_payment_page()  # 核对订单页面点击提交订单
        mes = get_text_element_func('订单提交成功')
