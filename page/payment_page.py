...
class PaymentPage(BasePage):
    ...
    def __init__(self):
        ...
        self.payment_method = By.ID,'input-ALIPAY-1' # 支付方式按钮
        self.confirm_payment = By.CLASS_NAME,'button-style-5' # 确认支付方式
    ...
    def find_payment_method(self):
        '''定位支付方式'''
        return  self.find_elements_func(self.payment_method,1)
