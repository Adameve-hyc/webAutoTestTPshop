...
class IndexPage(BasePage):
    ...
    def __init__(self):
        super().__init__()
        # self.login_link = By.LINK_TEXT, '登录' # 登录按钮
        # self.search_bar = By.ID,'q'  # 商品搜索框
        # self.search_button = By.CLASS_NAME,'ecsc-search-button'  # 搜索按钮
        # self.my_order_link = By.LINK_TEXT,'我的订单' # 我的订单
